...
<body class="h-screen w-screen bg-gray-100 flex items-center justify-center">
  ...
  <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
    <div class="max-w-md">
      <div class="text-5xl font-bold">419</div>
      ...
      <a href="{{ url()->previous() }}" class="px-4 inline py-2 text-sm font-medium shadow text-white rounded-lg bg-blue-600 hover:bg-blue-700">

    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 w-full">
        ...
        <div class="flex min-h-screen bg-gray-100">
            <div x-data="{ open: true }"
                class="flex flex-col w-64 bg-white border-r dark:bg-gray-800 dark:border-gray-700"
                :class="{ 'w-64': open, 'w-20': !open }">
                <button @click="open = !open" class="p-4 focus:outline-none">
                    <svg class="w-6 h-6 text-gray-600 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <aside id="sidebar"
                    ...
                    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                        ...
                        <div class="absolute bottom-4 left-0 w-full px-3">
                            <ul
                                class="mt-4 space-y-4 font-medium dark:text-white border-t border-gray-300 dark:border-gray-600 pt-4">
                                <li>
                                    <a href="/admin/akun"
                                        class="flex items-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
                                ...
                                <li>
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit"
                                            class="flex items-center p-2 text-red-500 hover:bg-red-100 rounded">

    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 w-full">
            ...
            <div class="flex min-h-screen bg-gray-100">
                <!-- Sidebar -->
                <div x-data="{ open: true }" class="flex flex-col w-64 bg-white border-r" :class="{ 'w-64': open, 'w-20': !open }">
                    ...
                    <aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
                        <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
                            <ul class="space-y-4 font-medium">
                                <li>
                                    <a href="/admin/dashboard" class="flex items-center p-2 hover:bg-gray-100 rounded">
                                        <i class="fi fi-rr-home mr-2"></i> Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a href="/admin/wisata" class="flex items-center p-2 hover:bg-gray-100 rounded">
                                        <i class="fi fi-rr-map-marker mr-2"></i> Menu Wisata
                                    </a>
                                </li>
                                <li>
                                    <a href="/admin/fasilitas" class="flex items-center p-2 hover:bg-gray-100 rounded">
                                        <i class="fi fi-rr-tools mr-2"></i> Menu Fasilitas
                                    </a>
                                </li>
                                <li>
                                    <a href="/admin/pengunjung" class="flex items-center p-2 hover:bg-gray-100 rounded">
                                        <i class="fi fi-rr-users mr-2"></i> Data Pengunjung
                                    </a>
                                </li>
                            </ul>
                            <div class="absolute bottom-4 left-0 w-full px-3">
                                <ul class="mt-4 space-y-4 font-medium border-t border-gray-300 pt-4">
                                    <li>
                                        <a href="/admin/akun" class="flex items-center p-2 hover:bg-gray-100 rounded">
